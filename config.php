<?php
/**
 * Configuración del cliente — Landing Page Origen8.8.
 *
...
return [
    ...
    'paginas' => [
        'home' => [
            'titulo' => 'Origen8.8 — Indumentaria Deportiva en Río Tercero',
        ...
        'productos' => [
            'titulo' => 'Productos — Origen8.8',
            'descripcion' => 'Catálogo de indumentaria deportiva Origen8.8 en Río Tercero: shorts, tops, calzas, calzado y prendas outdoor.',
            'h1' => 'Productos',
            'subtitulo' => 'Indumentaria deportiva para running, trekking, gym y movimiento diario.',
        ],
        'ofertas' => [
            'titulo' => 'Ofertas — Origen8.8',
            'descripcion' => 'Ofertas y oportunidades en indumentaria deportiva, outdoor y accesorios en Origen8.8.',
            'h1' => 'Ofertas',
            'subtitulo' => 'Oportunidades seleccionadas y productos con descuento para consultar por WhatsApp.',
        ],
        'accesorios' => [
            'titulo' => 'Accesorios — Origen8.8',
        ...
        'carrito' => [
            'titulo' => 'Mi pedido — Origen8.8',
            'descripcion' => 'Prepará tu pedido para consultar stock y precio final con Origen8.8 por WhatsApp.',
            'h1' => 'Mi pedido',
            'subtitulo' => 'Enviaremos tu pedido por WhatsApp con todos los detalles para que el negocio confirme precio final y disponibilidad.',
        ],
    ],
    ...
    'catalogo' => [
        [
            ...
            'video' => '',
            'alt' => 'Docena de medias tenis blanca Origen8.8',
            'rutas' => ['productos'],
        ...
        [
            ...
            'video' => '',
            'alt' => 'Docena de medias tenis colores Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
            'tags' => ['medias', 'tenis', 'running'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Medias tobilleras I-Run unisex Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Medias unisex I-Run Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
            'tags' => ['medias', 'running', 'unisex'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Biker I-Run mujer Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Biker I-Run negro Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
            'tags' => ['calzas', 'biker', 'running'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Calza running con cierres Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
        ...
        [
            ...
            'alt' => 'Pantalón desmontable técnico Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Short microfibra I-Run dama Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Indumentaria',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Musculosa deportiva Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Musculosa dryfit I-Run Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera corte alto Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera cuello en V microperforada Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera cuello en V varios talles Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera cuello V detalle en cintura Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
            'tags' => ['remeras', 'dama', 'gym'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Remera hombre cuello redondo Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera I-Run dama detalle espalda Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Remera I-Run dama Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
            'tags' => ['remeras', 'dama', 'running'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Top deportivo I-Run dama Origen8.8',
            'rutas' => ['productos'],
            'categoria' => 'Ropa',
            'tags' => ['tops', 'dama', 'gym'],
        ],
        [
            ...
            'alt' => 'Bolso I-RUN negro Origen8.8',
        ...
        [
            ...
            'alt' => 'Botella infantil Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Botellas térmicas infantiles Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
            'tags' => ['botellas', 'infantil', 'hidratación'],
        ],
        [
            ...
            'video' => '',
            'alt' => 'Botellas de hidratación Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Botellas metálicas Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'video' => '',
            'alt' => 'Gorras, gorros y sombreros Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'alt' => 'Lentes deportivos Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'miniatura' => '',
            'video' => '',
            'alt' => 'Cinturón de hidratación Navajo Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
        ...
        [
            ...
            'alt' => 'Chaleco de hidratación Navajo 7L Origen8.8',
            'rutas' => ['productos', 'accesorios'],
            'categoria' => 'Accesorios',
    ...
    'seccion_ofertas' => [
        ...
        'ofertas' => [
            [
                'nombre'      => 'Abrigos',
                'subtitulo'   => 'Outdoor que se adapta a tu ritmo',
            ...
            [
                'nombre'      => 'Chalecos',
                'subtitulo'   => 'Comfort en tonos neutros',
    ...
    'seccion_campania_verano' => [
        ...
        'imagenes' => [
            [
                'alt'   => 'Nueva Colección Verano — Origen8.8',
    ...
    'seccion_local' => [
        ...
        'exterior'   => [
            ['imagen' => '/assets/img/cliente/local/exterior/frente.webp',  'alt' => 'Frente del local Origen8.8'],
            ['imagen' => '/assets/img/cliente/local/exterior/derecha.webp', 'alt' => 'Vista lateral del local Origen8.8'],
        ],
    ],
    ...
    'seccion_como_llegar' => [
        ...
        'saludo'   => 'Te esperamos',
        'interior' => [
            ['imagen' => '/assets/img/cliente/local/interior/interior.webp', 'alt' => 'Interior del local Origen8.8'],
            ['imagen' => '/assets/img/cliente/local/interior/vidriera.webp', 'alt' => 'Vidriera del local Origen8.8'],
        ],
    ],
    ...
    'seccion_indumentaria' => [
        ...
        'intro_alt' => 'Indumentaria deportiva en Origen8.8',
        'mostrador_img' => '/assets/img/cliente/local/interior/mostrador-lentes.webp',
        'mostrador_alt' => 'Mostrador de lentes en Origen8.8',
    ...
    'nosotros_texto' => "En Origen8.8 no buscamos solo ventas: buscamos personas, vínculos y buena onda. Cada charla, cada risa y cada recomendación hacen que este lugar tenga sentido. Por eso elegimos ropa y accesorios para que tu tiempo libre se viva en movimiento y con la mejor energía. Gracias por estar del otro lado y por hacer de Origen8.8 mucho más que un local.",
    'nosotros_video' => '/assets/vid/identidad/videoviral/video-viral.mp4',
    'nosotros_video_poster' => '',
    'nosotros_video_titulo' => 'Origen8.8 — Gracias por ser parte',
