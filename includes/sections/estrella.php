...
<?php if (!empty($ofertas['ofertas'])): ?>
<section id="ofertas" class="section section-ofertas" aria-label="Ofertas de la temporada que se va">
    <div class="section-container">
        <h2 class="section-title"><?= htmlspecialchars($ofertas['titulo'] ?? 'Ofertas') ?></h2>
        <p class="section-subtitle"><?= htmlspecialchars($ofertas['subtitulo'] ?? '') ?></p>
                ...
                <div class="oferta-body">
                    ...
                    <a href="<?= $wa_full ?>"
                       ...
                       class="btn-oferta">
                        ...
                        <?= htmlspecialchars($cta_textos[$index % count($cta_textos)]) ?>
                    </a>
                </div>
            </article>
            <?php endforeach; ?>
